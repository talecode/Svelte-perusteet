...
Svelte on uudenlainen "framework" joka toimii oikeastaan vain kääntäjänä(compiler). Sveltellä kehitetty sovellus käännetään etukäteen(is compiled beforehand), hyvin optimoiduksi standalone JavaScriptiksi. Tämän ansiosta selaimen suorittama työ saadaan paljon pienemmäksi, kun verrataan perinteisillä frameworkeillä toteutettuihin web-sovelluksiin, joissa selain suorittaa myös frameworkin omaa koodia. 
